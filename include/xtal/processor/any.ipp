...
#include "../control/sequel.ipp"
#include "../control/resize.ipp"
...
struct defer<U>
{
	...
	public:
		...
		XTAL_0EX
		{
			return _detail::impurify_f(reified_<decltype(xs)...>(constant_t<Ks>{}...) (XTAL_REF_(xs)...));
		}
		template <auto ...Ks>
		XTAL_FN2 method(XTAL_DEF ...xs)
		XTAL_0EX
		...
		{
			return reified_<decltype(xs)...>(constant_t<Ks>{}...) (XTAL_REF_(xs)...);
		}
		template <auto ...Ks>
		XTAL_FN2 method(XTAL_DEF ...xs)
		XTAL_0FX
