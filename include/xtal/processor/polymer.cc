...
/**/
	...
	using U_slider = schedule::slider_t<scheme::spooled<extent_constant_t<0x20>>>;
	using U_cue    = flow::cue_s<>;

	using A_stored  = scheme::stored  <extent_constant_t<N_store>>;
	using A_spooled = scheme::spooled <extent_constant_t<N_spool>>;

	using A_gate   = bond::compose<typename U_slider::template suspend<Ox_level>, typename U_stage::attach<>>;
...
TAG_("polymer", "occur", "spine")
{
	...
	using A_stored  = scheme::stored  <extent_constant_t<-1>>;
	using A_spooled = scheme::spooled <extent_constant_t<64>>;

	using U_gate   = process::confined_t<void
	,	typename U_slider::template suspend<Ox_level>
...
void polymer_provision_spool__combined()
{
	...
	,	scheme::stored <extent_constant_t<N_store>>
	,	scheme::spooled<extent_constant_t<N_spool>>
	>;
