...
//		XTAL_NEW_(create) (subtype, noexcept=default)
	...
	public:// OPERATE
		...
		XTAL_FX4_(dot) (XTAL_DEF_(return,inline,get) sample, sample_f)
		XTAL_FX4_(dot) (XTAL_DEF_(return,inline,get) period, period_f)
		XTAL_FX4_(dot) (XTAL_DEF_(return,inline,get)   rate,   rate_f)
