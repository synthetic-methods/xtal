...
static_assert(bond::tag_inner_p<couple_t, couple_t<int[2]>>);
static_assert(bond::tag_inner_fixed_p<couple_t, couple_t<int[2]>>);
static_assert(bond::tag_inner_fixed_p<couple_t, couple_t<int[2]>, int[2]>);
