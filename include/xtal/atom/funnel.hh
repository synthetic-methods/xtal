...
template <class ..._s> struct   funnel;
template <class ..._s> using    funnel_t = typename funnel<_s...>::type;
template <class ...Ts> concept  funnel_q = bond::tag_inner_p<funnel_t, Ts...>;


////////////////////////////////////////////////////////////////////////////////
/*!
\brief   A priority-queue based on `atom::buffer_t<A>`.
\details Currently used for both event funnels and to implement polymorphism.
...
{
	template <class T>
	using endotype = xtd::ranges::view_interface<T>;

	template <class T>
	using holotype = bond::compose_s<endotype<T>, bond::tag<funnel_t>>;
	...
	public:
		...
		/*!
		\brief   Initializes the funnel with the given `end()`ing.
		...
		*/
		...
		{}
		/*!
		\brief   Initializes the funnel with the given `begin()`ing and `end()`ing.
