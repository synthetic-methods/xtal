...
/////////////////////////////////////////////////////////////////////////////////
///\
Governs access to the arguments of `flux::bracket`. \
...
template <  int N, class ...Ts>	XTAL_REQ slot_p = nominal_q<Ts...> and (some_q<Ts...> and not exclusive_q<N, Ts::value...>);
template <class T,   int ...Ns>	XTAL_REQ slot_q = nominal_q<T    > and (none_n<Ns...> or      inclusive_q<T::value, Ns...>);
