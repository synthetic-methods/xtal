...
{
	auto &o = z.template self<bias_t>();
	REQUIRE(-1 == z.influx(control::start_t()));                           // unrecognized
	REQUIRE( 0 == z.influx(bias_t(0.0))); REQUIRE(0.0 == (float) o.head());// unchanged
	REQUIRE( 1 == z.influx(bias_t(1.0))); REQUIRE(1.0 == (float) o.head());// changed
	REQUIRE( 1 == z.influx(bias_t(2.0))); REQUIRE(2.0 == (float) o.head());// changed
	REQUIRE( 1 == z.influx(bias_t(3.0))); REQUIRE(3.0 == (float) o.head());// changed
	REQUIRE(13.0 == (float) z(1.0, 2.0, 3.0, 4.0));
}
...
{
	auto &o = z.template self<bias_t>();
	REQUIRE(-1 == z.efflux(control::start_t()));                           // unrecognized
	REQUIRE( 0 == z.efflux(bias_t(0.0))); REQUIRE(0.0 == (float) o.head());// unchanged
	REQUIRE( 1 == z.efflux(bias_t(1.0))); REQUIRE(1.0 == (float) o.head());// changed
	REQUIRE( 1 == z.efflux(bias_t(2.0))); REQUIRE(2.0 == (float) o.head());// changed
	REQUIRE( 1 == z.efflux(bias_t(3.0))); REQUIRE(3.0 == (float) o.head());// changed
	REQUIRE(13.0 == (float) z(1.0, 2.0, 3.0, 4.0));
}
