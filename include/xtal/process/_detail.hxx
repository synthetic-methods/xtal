...
template <class X> using endoscalar_t = typename bond::realize<X>::delta_t;
template <class X> using ectoscalar_t = typename bond::realize<X>::alpha_t;
...
template <array_q Xs> using ipsovector_t = group::serial_t<array_t<Xs>>;
template <array_q Xs> using endovector_t = group::serial_t<endoscalar_t<value_t<Xs>>[arity_n<Xs>]>;
template <array_q Xs> using ectovector_t = group::serial_t<ectoscalar_t<value_t<Xs>>[arity_n<Xs>]>;
