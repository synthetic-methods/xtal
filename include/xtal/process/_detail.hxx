...
template <array_q Xs> using ipsovector_t = atom::serial_t<array_t<Xs>>;
template <array_q Xs> using endovector_t = atom::serial_t<endoscalar_t<value_t<Xs>>[arity_n<Xs>]>;
template <array_q Xs> using ectovector_t = atom::serial_t<ectoscalar_t<value_t<Xs>>[arity_n<Xs>]>;
