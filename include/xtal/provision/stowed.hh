...
//		XTAL_NEW_(create) (subtype, noexcept=default)
	...
	//	XTAL_NEW_(else)   (subtype, noexcept:S_)
		...
		XTAL_FX2_(to) (XTAL_DEF_(return,inline,get) store(), S_::template head<constant_t<1>>())
		XTAL_FX2_(to) (XTAL_DEF_(return,inline,get) state(auto &&...oo), S_::template head<constant_t<0>>(XTAL_REF_(oo)...))
