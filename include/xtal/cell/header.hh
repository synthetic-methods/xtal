...
////////////////////////////////////////////////////////////////////////////////
/*!
\brief  	Insulated header abstraction.
\brief  	The supplied types must include a self-`tag`ged decorator to support reparameterization.

The supplied types `..._s` are composed via `reinfers` then `confined`,
