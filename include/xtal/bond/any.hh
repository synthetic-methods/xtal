...
struct define
{
	...
	public:
		...
		XTAL_FX4_(dot) (template <class Y=T> XTAL_DEF_(return,inline,get) self, self_f<Y>)///<\returns	A reference to `*this` with type `Y=T`.
		XTAL_FX4_(dot) (template <class Y=T> XTAL_DEF_(return,inline,let) twin, self_f<Y>)///<\returns	A copy      of `*this` with type `Y=T`.
		XTAL_FX4_(dot) (                     XTAL_DEF_(return,inline,get) tail, self_f<S>)///<\returns	`this` as the `define`d supertype.
