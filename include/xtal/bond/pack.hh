...
template <class        ...Us> struct   pack         {using type = _std::tuple<_xtd::remove_rvalue_cvref_t<Us>...>;};
template <class U0, class U1> struct   pack<U0, U1> {using type = _std::pair <_xtd::remove_rvalue_cvref_t<U0>, _xtd::remove_rvalue_cvref_t<U1>>;};
...
noexcept -> auto
{
	return pack_t<_xtd::remove_rvalue_cvref_t<decltype(_s)>...>(XTAL_REF_(_s)...);
};
