...
TAG_("operate")
{
	...
	{
		TRUE_((one << 2.0) == 4.0000000000000000);
		TRUE_((one << 1.5) == 2.8284271247461903);
		TRUE_((one << 1.0) == 2.0000000000000000);
		TRUE_((one << 0.5) == 1.4142135623730951);
		TRUE_((one << 0.0) == 1.0000000000000000);
		TRUE_((one >> 0.0) == 1.0000000000000000);
		TRUE_((one >> 0.5) == 0.7071067811865476);
		TRUE_((one >> 1.0) == 0.5000000000000000);
		TRUE_((one >> 1.5) == 0.3535533905932738);
		TRUE_((one >> 2.0) == 0.2500000000000000);
