...
template <class 	                        ...Ts>	XTAL_REQ taboo_q = (...and requires {typename Ts::taboo;});
...
template <                        class   ...Ts>	XTAL_REQ twin_tab_q      = taboo_q<Ts...> and self_tab_q<Ts...> and infungible_q<Ts...>;
