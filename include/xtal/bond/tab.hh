...
template <class T             >	using   tab_u = typename based_t<T>::taboo::peritype;
...
template <tab_q T,    identity_q K, class ...Ks> requires different_q<tab_u<T>, identity_u<K>> struct tab_as<T,       K , Ks...> :  tab_as<tab_s<T>,             K,  Ks...> {};
template <tab_q T,    identity_q K, class ...Ks> requires      same_q<tab_u<T>, identity_u<K>> struct tab_as<T,       K , Ks...> :  tab_as<tab_s<T>,                 Ks...> {};
template <tab_q T,         different_q<T> ...Ks>                                               struct tab_as<T, tab_u<T>, Ks...> :  tab_as<tab_s<T>,                 Ks...> {};
...
template <                   tab_q ..._s>	struct  tab_comparable<      _s...> :                                             isotropic_t<tab_u<_s>...>  {};// `T == _s...`             (shallow)
