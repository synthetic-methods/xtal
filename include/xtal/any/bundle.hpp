...
template <typename T        > concept  bundle_size_b = constant_b<bundle_size_t<T>>;
...
template <typename T        > concept  bundle_part_p = [] <auto ...Ns>
	(seek_t<Ns...>) XTAL_0FN_(unfalse_p<bundle_part_b<T, Ns>...>)
...
struct bundle
{
	...
	template <auto N> using part   = bundle_part  <type, N>;
	template <auto N> using part_t = bundle_part_t<type, N>;
...
template <typename ...Ts> concept  bundle_q = unfalse_p<bundle_b<Ts>...>;
